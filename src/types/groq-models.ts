...
export const GROQ_MODELS: GroqModelConfig[] = [
  {
    ...
    description: "Automatically picks the best model based on your query",
    modelString: "auto",
    maxTokens: 8192,
  },
  {
    id: "llama-4-scout",
    name: "Llama 4 Scout",
    description: "Best all-rounder — great for coding, reasoning, and general chat",
  ...
  },
  {
    id: "llama-3.3-70b",
    name: "Llama 3.3 70B",
    description: "Reliable and versatile — excellent for complex tasks",
  ...
  },
  {
    id: "qwen-3-32b",
    name: "Qwen 3 32B",
    description: "Strong reasoning — great for math and science problems",
  ...
  },
  {
    ...
    description: "Specialized reasoning — excels at math, physics, and logic",
  ...
  },
  {
    id: "llama-3.1-8b",
    name: "Llama 3.1 8B",
    description: "Fast and lightweight — perfect for quick questions and greetings",
  ...
  },
  {
    id: "gemma2-9b",
    name: "Gemma 2 9B",
    description: "Creative and conversational — great for brainstorming and ideas",
