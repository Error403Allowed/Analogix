...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    description: "Make Analogix yours! Expand the sidebar to see colour theme swatches — choose from Blue, Sunset, Forest, Yellow, and more. Dark/light mode is right there too.",
    placement: "right",
    padding: 6,
  },
  {
