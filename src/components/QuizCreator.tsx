...
import { Sparkles, Loader2, Copy, FileText, Wand2 } from "lucide-react";
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Paste your study material and I'll create a fun quiz!
          </p>
        </div>
      </div>
...
- Important dates for upcoming exam..."
              ...
              className="min-h-[200px] mb-4 glass border-border focus:border-primary transition-colors"
            />
