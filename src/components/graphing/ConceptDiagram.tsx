...
export interface ConceptDiagramSpec {
  title: string;
  description: string;
  sceneType?: string;
  primaryColor?: string;
...
// Legacy aliases (pre-rename ThreeScene names keep working)
export type ThreeObject = ConceptNode;
export type ThreeConnection = ConceptConnection;
export type ThreeSceneSpec = ConceptDiagramSpec;
...
function renderObjectSVG(obj: ConceptNode, viewBox: { w: number; h: number }): React.ReactNode {
...
function renderConnections(objects: ConceptNode[], connections: ConceptConnection[] | undefined, viewBox: { w: number; h: number }): React.ReactNode {
...
interface ConceptDiagramProps {
  spec: ConceptDiagramSpec;
  className?: string;
}

export default function ConceptDiagram({ spec, className }: ConceptDiagramProps) {
