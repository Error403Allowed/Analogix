...
import {
  ...
  BookOpenText, ExternalLink, Users, Loader2
} from "lucide-react";
    ...
    <>
      <style>{`
        .landing-hardcoded-theme {
          ...
          --accent: 210 20% 97% !important;
          --accent-foreground: 210 20% 38% !important;
          --destructive: 0 84% 60% !important;
          --border: 0 0% 92% !important;
          --input: 0 0% 97% !important;
          --ring: var(--p-h) var(--p-s) var(--p-l) !important;
          --radius: 0.375rem !important;
        }
      `}</style>
    <div ref={containerRef} className="min-h-screen bg-background text-foreground selection:bg-primary/30 relative landing-hardcoded-theme">
      <CursorParticles />
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="w-8 h-8 rounded-full hover:bg-primary/40 flex items-center justify-center transition-colors text-muted-foreground hover:text-primary-foreground border border-border"
