...
export const ACCEPTED_FILE_TYPES = ".pdf,.docx,.doc,.pptx,.txt,.md,.csv,.rtf,.png,.jpg,.jpeg,.webp,.gif,.heic,.heif,text/*,image/*";
/** Label for upload UI */
export const ACCEPTED_FILE_LABEL = "PDF, Word, PowerPoint, TXT, CSV, images (PNG, JPG, HEIC, etc.)";
//# sourceMappingURL=extractFileText.js.map