...
- **Academic Research Search** - Search academic papers with credible sources
...
- **Shared Documents** - Revise together with documents that can be shared by any user in the room
...
- **Email & Password Sign-in** - Supabase Auth with email provider

- **Onboarding** - Select subjects, grade, state, interests and import calendar
