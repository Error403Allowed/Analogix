...
test.describe('Login Auth', () => {
  ...
  test('renders the login page with email field and Google SSO', async ({ page }) => {
  ...
  test('shows password field after entering email', async ({ page }) => {
    ...
    const pwField = page.getByPlaceholder('Your password');
  ...
  test('switching to Sign Up changes password placeholder to Create a password', async ({ page }) => {
    await page.getByPlaceholder('name@email.com').waitFor({ state: 'visible', timeout: 15000 });
    await page.getByPlaceholder('name@email.com').fill('test@example.com');
  ...
  test('switching to Sign Up shows confirm password field', async ({ page }) => {
    await page.getByPlaceholder('name@email.com').waitFor({ state: 'visible', timeout: 15000 });
    await page.getByPlaceholder('name@email.com').fill('test@example.com');
    await page.getByPlaceholder('Your password').waitFor({ state: 'visible', timeout: 10000 });
