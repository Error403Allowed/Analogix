  ...
  return (
    ...
    >
      <View style={styles.overview}>
        <ExpressiveRailCard value={sets.length} label="Sets" icon="cards" />
        <ExpressiveRailCard value={sets.reduce((s: number, d: any) => s + (d.cardCount ?? 0), 0)} label="Cards" icon="cards-outline" />
      </View>
